...
import Banner_1 from '@/assets/images/banner/wakaf-melalui-uang-banner-1.png'
import Banner_2 from '@/assets/images/banner/wakaf-melalui-uang-banner-2.png'
  ...
  <Layouts>
    <div>
      <div class="flex gap-1 items-center z-10 py-3 px-5 bg-white shadow-lg rounded-b-xl">
        ...
        <p class="font-semibold capitalize">{{ route.meta.title }}</p>
      </div>
      <div class="pt-3">
        <Carousel :value="banners" :numVisible="1" :numScroll="1" autoplayInterval="3000">
